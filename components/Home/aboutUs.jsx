            ...
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center justify-center ">
                ...
                <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <div className="flex w-full md:justify-start  justify-center items-end">
                        <button className=" text-white bg-siteblue border-0 py-2 px-10 focus:outline-none hover:bg-sitegreen rounded-xl text-lg flex items-center gap-3"><span>Voir Plus</span>  <RightIcon /></button>
                    </div>
                    <div className="flex justify-between items-center overflow-hidden gap-7 mt-10" style={{ width: "80%" }}>
                        <div className="box space-y-2 align-middle">
