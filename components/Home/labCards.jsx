                ...
                <div className="rounded-lg shadow-lg bg-white max-w-sm">
                    ...
                    <div className="p-6">
                        <div className='flex flex-row space-x-2'>
                            <div>
                                <h5 className="text-gray-900 text-[16px] font-[700] mb-2">{props.labtitle}</h5>
                            </div>
                            <div className='py-1'>
